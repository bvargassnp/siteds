...
@XmlType(name = "", propOrder = { "coError", "txNombre", "coIafa", "txRespuesta" })
@XmlRootElement(name = "getConsultaxCartaGarantiaResponse")
public class GetConsultaxCartaGarantiaResponse {

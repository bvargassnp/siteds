...
@XmlType(name = "", propOrder = { "txNombre", "coIafa", "txPeticion", "coExcepcion" })
@XmlRootElement(name = "getConsultaxCartaGarantiaRequest")
public class GetConsultaxCartaGarantiaRequest {

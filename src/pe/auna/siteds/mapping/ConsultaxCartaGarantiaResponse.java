...
public class ConsultaxCartaGarantiaResponse extends AbstractTransformation {
	...
	// Dynamic Configuration Key for the target IdRemitente which will be used in
	// response message
	private static final DynamicConfigurationKey ID_REMITENTE = DynamicConfigurationKey
			.create("http://sap.com/xi/XI/System/IdRemitente", "IdRemitente");
	// Dynamic Configuration Key for the target Directory name which will be used in
	// response message validation
	private static final DynamicConfigurationKey NO_TRANSACCION = DynamicConfigurationKey
			.create("http://sap.com/xi/XI/System/NoTransaccion", "NoTransaccion");
	// Dynamic Configuration Key for the target TxNombre which will be used in
	// response message validation
	private static final DynamicConfigurationKey TX_NOMBRE = DynamicConfigurationKey
			.create("http://sap.com/xi/XI/System/TxNombre", "TxNombre");
	// Dynamic Configuration Key for the target CoIafa name which will be used in
	// response message validation
	private static final DynamicConfigurationKey CO_IAFA = DynamicConfigurationKey
			.create("http://sap.com/xi/XI/System/CoIafa", "CoIafa");
	// Dynamic Configuration Key for the target TxPeticion which will be used in
	// response message validation
	private static final DynamicConfigurationKey TX_PETICION = DynamicConfigurationKey
			.create("http://sap.com/xi/XI/System/TxPeticion", "TxPeticion");
	// Dynamic Configuration Key for the target CoExcepcion name which will be used
	// in response message validation
	private static final DynamicConfigurationKey CO_EXCEPCION = DynamicConfigurationKey
			.create("http://sap.com/xi/XI/System/CoExcepcion", "CoExcepcion");
	...
	private String validarGetConsultaxCartaGarantiaRequest(GetConsultaxCartaGarantiaRequest request) {
		...
		if (request == null) {
			...
			if (request.getTxNombre().isEmpty()) {
				rsp = "0300";
			} else if (!request.getTxNombre().equalsIgnoreCase("278_SOL_CG")) {
				rsp = "0310";

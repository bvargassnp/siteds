...
import pe.auna.siteds.beans.GetConsultaAsegNomRequest;
...
public class ConsultaAsegNomRequest extends AbstractTransformation {
    ...
    public void execute(InputStream in, OutputStream out) throws StreamTransformationException {
    	this.addInfoMessage("Iniciando Proceso de Mapeo: ConsultaAsegNomRequest...");

    	try {
    		Document documentIn = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(in);
    		GetConsultaAsegNomRequest getConsultaAsegNomRequest = this.getConsultaAsegNomRequest(documentIn);
    		Document documentOut = this.buildRequestMessage(getConsultaAsegNomRequest);
        	TransformerFactory.newInstance().newTransformer().transform(new DOMSource(documentOut), new StreamResult(out));
        	this.addInfoMessage("Finalizando Proceso de Mapeo: ConsultaAsegNomRequest...");
        } catch (Exception e) {
    ...
    public GetConsultaAsegNomRequest getConsultaAsegNomRequest(Document documentIn) {
    	String codigoExcepcion = this.getElementText(documentIn, "coExcepcion");
    	GetConsultaAsegNomRequest getConsultaAsegNomRequest = new GetConsultaAsegNomRequest();
    ...
    private Document buildRequestMessage(GetConsultaAsegNomRequest request) throws ParserConfigurationException {
        ...
        Element rootElement = documentOut.createElementNS(docNS, "ConsultaAsegNomRequest");
